...
public class ReadyMoneyOutApply {
    private Integer id;
    ...
    public ReadyMoneyOutApply() {
    }

    public ReadyMoneyOutApply(Integer id, Long createTime, Integer grouperId, String libraryerId, Long approvalTime, String approvalPeople, Integer state, Integer totalNumber, Integer libraryId, String normalResult, String supplementResult, String inventoryResult) {
        this.id = id;
        this.createTime = createTime;
        this.grouperId = grouperId;
